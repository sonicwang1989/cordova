angular.module('myService', [])
    ...
    .factory('Language', ['$http', function ($http) {
        //获取语言包
        var language_get = function () {
            var lang = $util.getStorage('language');
            if (!lang == undefined) {
                lang = 'zh_cn';
            }
            return $http.get('./lang/' + lang + '.json');
        }
        //设置语言包
        var language_set = function (language) {
            var lang;
